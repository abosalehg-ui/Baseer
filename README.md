...
تطبيق احترافي لتحويل مئات المقاطع المرورية (داش كام، CCTV، سوشل ميديا) إلى بيانات منظمة قابلة للتحليل، يعمل بدون أي اعتماد على السحابة. مبني بـ **Python 3.10+ • PyQt6 • DuckDB • YOLOv8 • PaddleOCR**.
